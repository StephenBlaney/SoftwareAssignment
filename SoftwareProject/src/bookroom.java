...
public class bookroom extends JFrame {
	...
	JButton loginButton = new JButton("Book Room");
	...
	public bookroom() {
		...
		JLabel introLabel = new JLabel("Welcome To The Room Booking Page");

		JLabel loginLabel = new JLabel("Please Enter your requried room");

		JLabel loginLabel1 = new JLabel("Please Enter your requried time");
		...
		loginButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showInputDialog(null, "Are you sure you want thesse times ",
						(combo1.getSelectedItem().toString() + " At " + combo2.getSelectedItem().toString()));
				
				
				JOptionPane.showMessageDialog(null, "Room booked succesfully", "Room booked",
